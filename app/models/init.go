...
func InitDB() {
	...
	// config_file := ("../../conf/databases.conf")
	// config_file := ("")
	...
	DB_Read.Sync(new(Admin), new(User), new(Attachment), new(Sharing))
	...
	DB_Write.Sync(new(Admin), new(User), new(Attachment), new(Sharing))
